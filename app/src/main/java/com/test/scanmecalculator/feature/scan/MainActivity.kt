...
import com.test.scanmecalculator.BuildConfig
import com.test.scanmecalculator.R
import com.test.scanmecalculator.core.extension.toBitmap
...
class MainActivity : AppCompatActivity() {
    ...
    private fun bindingViews() {
        if (BuildConfig.FLAVOR.lowercase().contains("camera")) {
            binding.btnAddInputFile.visibility = View.GONE
        } else if (BuildConfig.FLAVOR.lowercase().contains("file")) {
            binding.btnAddInputCamera.visibility = View.GONE
        }

        binding.btnAddInputCamera.setOnClickListener {
            if (checkPermission()) capturePhoto() else requestPermission()
        }

        binding.btnAddInputFile.setOnClickListener {
    ...
    private val getContent = registerForActivityResult(ActivityResultContracts.GetContent()) { uri: Uri? ->
        ...
        imageUri?.let {
            ...
            val convertedBitmap = it.toBitmap(contentResolver)
            convertedBitmap?.let {
