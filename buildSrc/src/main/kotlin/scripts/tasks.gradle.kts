...
//    val installAppTask = ":app:install${scripts.Variants_gradle.Default.BUILD_VARIANT}"
//
...
//
//        val applicationPackage = "com.fernandocejas.sample.${scripts.Variants_gradle.Default.BUILD_FLAVOR}.${scripts.Variants_gradle.Default.BUILD_TYPE}"
